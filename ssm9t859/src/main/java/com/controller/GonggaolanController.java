...
public class GonggaolanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,GonggaolanEntity gonggaolan, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GonggaolanEntity gonggaolan, HttpServletRequest request){
        EntityWrapper<GonggaolanEntity> ew = new EntityWrapper<GonggaolanEntity>();
		PageUtils page = gonggaolanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, gonggaolan), params), params));
        return R.ok().put("data", page);
    }
